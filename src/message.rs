...
impl TryFrom<xmpp_parsers::minidom::Element> for Message {
    type Error = ();

    fn try_from(value: xmpp_parsers::minidom::Element) -> Result<Self, Self::Error> {
...
mod tests {
    ...
    fn parse_awips() {
        let timestamp = chrono::DateTime::from_naive_utc_and_offset(
            chrono::NaiveDate::from_ymd_opt(2022, 2, 4)
                .unwrap()
                .and_hms_opt(2, 54, 0)
                .unwrap(),
        ...
        assert_eq!(
            ...
            Ok(Message {
                ...
                issue: timestamp,
                id: "14425.25117".into(),
                delay_stamp: timestamp.with_minute(55).unwrap().with_second(11).unwrap().with_nanosecond(810_000_000),
        ...
        assert_eq!(
            ...
            Ok(Message {
                ...
                issue: timestamp.with_minute(11).unwrap(),
                id: "14425.24041".into(),
                delay_stamp: None,
        ...
        assert_eq!(
            ...
            Ok(Message{
                ...
                issue: timestamp.with_minute(0).unwrap(),
                id: "14425.22838".into(),
                delay_stamp: None,
    ...
    fn parse_test() {
        assert_eq!(
            ...
            Ok(Message {
                ...
                cccc: "PHEB".into(),
                awips_id: None,
                issue: chrono::DateTime::from_naive_utc_and_offset(chrono::NaiveDate::from_ymd_opt(2022, 2, 4).unwrap().and_hms_opt(1, 23, 0).unwrap(), chrono::FixedOffset::east_opt(0).unwrap()),
                id: "14425.22800".into(),
                delay_stamp: None,
